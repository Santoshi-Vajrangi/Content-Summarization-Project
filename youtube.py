...
class PalmYoutube(object):
    ...
    def scrape_all_with_replies(self, video_url):
        ...
        summaryGenerator = PalmYoutube(concatenated_comments)
        ...
        if generated_summary is not None:
            ...
            print(
                "Error generating summary. Check for issues in the summary generation process."
            )

        reference_summary = "Video about ps5 console by diyperks matt. good build"
        rouge_scores = PalmYoutube.calculate_rouge(generated_summary, reference_summary)
